...
FLOWS="palette_nav palette_drill settings_palette settings_palette_override settings_palette_agent_empty onboarding_install completion_scroll workspace_filter workspace_rename workspace_overflow update_states menubar_arrival"
