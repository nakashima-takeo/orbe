...
final class WindowControllerWorkspaceTests: OrbeTestCase {
  ...
  func testSwitchWorkspaceChangesActive() {
    let wc = WindowController()
    wc.createWorkspace(name: "infra", rootPath: wc.store.activeTabCwdOrHome())  // index 1, active
  ...
  func testRoundTripSwitchPreservesWorkspaces() {
    let wc = WindowController()
    wc.createWorkspace(name: "alpha", rootPath: wc.store.activeTabCwdOrHome())  // index 1
    wc.createWorkspace(name: "beta", rootPath: wc.store.activeTabCwdOrHome())  // index 2, active
  ...
  func testRenameActiveWorkspaceUpdatesTitle() {
    let wc = WindowController()
    wc.createWorkspace(name: "old", rootPath: wc.store.activeTabCwdOrHome())  // index 1, active
  ...
  func testRenameInactiveWorkspaceIsRetained() {
    let wc = WindowController()
    wc.createWorkspace(name: "tmp", rootPath: wc.store.activeTabCwdOrHome())  // index 1, active
  ...
  func testCloseInactiveWorkspaceKeepsActive() {
    let wc = WindowController()
    wc.createWorkspace(name: "keep", rootPath: wc.store.activeTabCwdOrHome())  // index 1, active
    wc.createWorkspace(name: "drop", rootPath: wc.store.activeTabCwdOrHome())  // index 2, active
  ...
  func testCloseActiveWorkspaceSwitchesToAnother() {
    let wc = WindowController()
    wc.createWorkspace(name: "second", rootPath: wc.store.activeTabCwdOrHome())  // index 1, active
  ...
  func testFlushSaveThenReloadRestoresAcrossInstances() throws {
    ...
    // index 1, active
    wc1.createWorkspace(name: "persisted", rootPath: wc1.store.activeTabCwdOrHome())
