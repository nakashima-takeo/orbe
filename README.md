...
**フル Xcode（Xcode 26 系以上）・Metal Toolchain・Zig 0.16.0（`mise install` で導入）** を用意してください。Command Line Tools だけではビルドできません。ツールの導入・環境確認は[ビルドガイド](docs/guides/build.md)にまとめています。
